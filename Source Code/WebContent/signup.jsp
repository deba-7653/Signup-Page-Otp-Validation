<%@page import="com.enity.Register"%>
		...
		<form action="signup" method="post">
			...
			<div class="col-sm-6 form-group">
				...
				<div class="col-sm-4 form-group">
					...
					<div class="col-sm-2 form-group">
					<label for="zip">Enter Otp</label> <input type="Password"
				...
				<%
				Register c1 = (Register) session.getAttribute("customerobj");
					RegisterDao dao2 = new RegisterDao(DBConn.getConn());
				
				Register p=dao2.getPersonById(c1.getPhone());
				...
				<div class="col-sm-6 form-group">
					<label for="name-f">First Name</label> <input type="text"
						class="form-control" name="fname" id="name-f"
						placeholder="Enter your first name." required value="<%=p.getFname()%>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="name-l">Last name</label> <input type="text"
						class="form-control" name="lname" id="name-l"
						placeholder="Enter your last name." required value="<%=p.getLname()%>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="email">Email</label> <input type="email"
						class="form-control" name="email" id="email"
						placeholder="Enter your email." required value="<%=p.getEmail()%>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="address-1">Address Line-1</label> <input type="address"
						class="form-control" name="Locality" id="address-1"
						placeholder="Locality/House/Street no." required value="<%=p.getAdress()%>">
				</div>

				<div class="col-sm-4 form-group">
					<label for="State">State</label> <input type="address"
						class="form-control" name="State" id="State"
						placeholder="Enter your state name." required value="<%=p.getState()%>">
				</div>
				<div class="col-sm-2 form-group">
					<label for="zip">Postal-Code</label> <input type="zip"
						class="form-control" name="Zip" id="zip"
						placeholder="Postal-Code." required value="<%=p.getPin()%>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="Country">Country</label> <input type="address"
						class="form-control" name="country" id="country"
						placeholder="Enter your country name." required value="<%=p.getCountry()%>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="Date">Date Of Birth</label> <input type="Date"
						name="dob" class="form-control" id="Date" placeholder="" required value="<%=p.getDob()%>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="sex">Gender</label> <select id="sex"
						class="form-control browser-default custom-select" name="sex" >
						
						<option value="<%=p.getGender()%>"><%=p.getGender()%></option>
						<option value="Male">Male</option>
						<option value="Female">Female</option>
						<option value="Unspecified">Unspecified</option>
					</select>
				...
				<div class="col-sm-6 form-group">
					<label for="pass">Password</label> <input type="Password"
						name="password" class="form-control" id="pass"
						placeholder="Enter your password." required value="<%=p.getPass()%>">
				</div>
				<div class="col-sm-6 form-group">
					<label for="pass2">Confirm Password</label> <input type="Password"
						name="cnf-password" class="form-control" id="pass2"
						placeholder="Re-enter your password." required value="<%=p.getRepass()%>" >
				</div>
				<div class="col-sm-6 form-group">
					<label for="tel">Phone</label> <input type="tel" name="phone"
						maxlength="10" class="form-control" id="tel"
						placeholder="Enter Your Contact Number." required value="<%=p.getPhone()%>">
				</div>
				<div class="col-sm-2 form-group">
					<label for="zip">Enter Otp</label> <input type="Password"
						class="form-control" name="otp" id="otp" placeholder="Otp"
